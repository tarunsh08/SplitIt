...
function App() {
  ...
  const [newExpense, setNewExpense] = useState({name: '', amount: 0, paidBy: ''});
  ...
  const perPersonAmount = participants.length > 0 ? totalAmount / participants.length : 0;
    ...
    <ThemeProvider theme={theme}>
      <BackgroundContainer>
        <ContentContainer maxWidth="md">
              ...
              <FloatingCard sx={{ flex: 1, minWidth: 200 }}>
                <CardContent sx={{ textAlign: 'center', py: 2 }}>
                  <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
                    ...
                    <Box>
                      <Typography variant="h4" fontWeight="bold">{participants.length}</Typography>
              ...
              <FloatingCard sx={{ flex: 1, minWidth: 200 }}>
                <CardContent sx={{ textAlign: 'center', py: 2 }}>
                  <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
                    ...
                    <Box>
                      <Typography variant="h4" fontWeight="bold">${totalAmount.toFixed(0)}</Typography>
          ...
          {activeTab === 'participants' && (
            <Grow in={activeTab === 'participants'} timeout={500}>
              <GlassPaper elevation={0}>
                  ...
                  <Zoom in={newParticipant.trim().length > 0}>
                    <NeonButton 
                      ...
                      sx={{
                        ...
                        '&:hover': {
                          background: 'linear-gradient(45deg, #00ee77, #00bb55)',
                        }
                      }}
                    >
                      Add
                ...
                <List sx={{ '& .MuiListItem-root': { borderRadius: '16px', mb: 1 } }}>
                  {participants.map((participant, index) => (
                    <Zoom in={true} key={participant} style={{ transitionDelay: `${index * 100}ms` }}>
                      <ListItem
                        sx={{
                          background: 'rgba(255, 255, 255, 0.1)',
                          backdropFilter: 'blur(10px)',
                      ...
                      >
                        <ListItemAvatar>
                          <GradientAvatar color={participantColors[index % participantColors.length]}>
                            <PersonIcon />
                          </GradientAvatar>
                        </ListItemAvatar>
                        <ListItemText 
              ...
              <GlassPaper elevation={0}>
                ...
                <Stack spacing={3} mb={3}>
                  ...
                  <StyledTextField
                    ...
                    InputProps={{
                      startAdornment: <MoneyIcon sx={{ color: 'rgba(255, 255, 255, 0.7)', mr: 1 }} />,
                    }}
                  />
                  ...
                  <Zoom in={newExpense.name.trim().length > 0 && newExpense.amount > 0 && newExpense.paidBy}>
                    <NeonButton 
                      variant="contained" 
                      onClick={addExpense}
                      startIcon={<AddIcon />}
                      ...
                      sx={{
                        ...
                        '&:hover': {
                          background: 'linear-gradient(45deg, #e000e0, #7000e0)',
                        }
                      }}
                    >
                      Add Expense
                ...
                <List sx={{ '& .MuiListItem-root': { borderRadius: '16px', mb: 1 } }}>
                  {expenses.map((expense, index) => (
                    <Slide direction="left" in={true} key={`${expense.name}-${index}`}>
                      <ListItem
                        sx={{
                          background: 'rgba(255, 255, 255, 0.1)',
                          backdropFilter: 'blur(10px)',
                      ...
                      >
                        ...
                        <ListItemText 
                          ...
                          secondary={`$${expense.amount.toFixed(2)} • Paid by ${expense.paidBy}`}
                          primaryTypographyProps={{
                            fontWeight: 600,
                            fontSize: '1.1rem',
                          }}
          ...
          <Fade in={participants.length > 0 && expenses.length > 0} timeout={800}>
            <Box textAlign="center" my={4}>
              <NeonButton
                ...
                sx={{ 
                  ...
                  fontSize: '1.2rem',
                  fontWeight: 700,
                  background: 'linear-gradient(45deg, #00ff88, #00cc66, #0099ff)',
                  backgroundSize: '200% 200%',
                  animation: 'gradient 3s ease infinite',
                        ...
                        <ListItemText 
                          primary={
                            <Box display="flex" alignItems="center" gap={1}>
                              ...
                              <SwapIcon fontSize="small" sx={{ color: '#00ff88' }} />
                              <Typography component="span" fontWeight={600}>
                                {settlement.to}
                              </Typography>
                            </Box>
